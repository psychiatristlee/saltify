...
export const metadata: Metadata = {
  ...
  description:
    '서울 홍대 소금빵 맛집 솔트빵(Salt,0). 홍대입구역 도보 5분, 연남동 카페거리. 수제 소금빵 7종 (시그니처 초코번 포함) + 콜드브루/제로슈가 밀크티. 영업시간 11:00-19:30 (일요일 휴무, 소진시 마감).',
  keywords:
  ...
  openGraph: {
    ...
    description:
      '서울 홍대·연남동 소금빵 맛집. 홍대입구역 5분, 바삭하고 고소한 수제 소금빵 전문 베이커리. 플레인, 갈릭버터, 시그니처 초코번 등 7종 + 콜드브루/밀크티. 소금빵 게임도 즐기고 무료 쿠폰도 받아보세요!',
    images: [
      {
