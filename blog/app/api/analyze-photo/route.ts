...
const REFERENCE_MENU = [
  { id: 'plain', name: '플레인 (토핑 없는 길쭉한 소금빵)', file: 'breads/plain-naver.jpg' },
  { id: 'everything', name: '에브리띵 (검은깨/참깨/양파 등 토핑)', file: 'breads/everything-naver.jpg' },
  { id: 'olive-cheese', name: '올리브치즈 (올리브와 치즈)', file: 'breads/olive-cheese-naver.jpg' },
  { id: 'basil-tomato', name: '바질토마토 (녹색 바질, 빨간 토마토)', file: 'breads/basil-tomato-naver.jpg' },
